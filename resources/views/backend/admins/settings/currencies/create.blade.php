        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">{{ __('web.currency') }}</div>
                </div>
            </div>
            <div class="section-body">
                <h2 class="section-title">{{ __('web.adding_new') . ' ' . __('web.currency') }}</h2>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admins.currencies.store') }}" method="post" >
                                @csrf
                                <div class="card-body">
                                            ...
                                            <div class="card-body col-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('symbol') is-invalid @enderror"
                                                           name="symbol" value="{{ old('symbol') }}" id="symbol" required>
                                                    @error('symbol')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="card-body col-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('rate') is-invalid @enderror"
                                                           name="rate" value="{{ old('rate') }}" id="rate" required>
                                                    @error('rate')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
