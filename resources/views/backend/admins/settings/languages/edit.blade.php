    ...
    <div class="main-content" style="min-height: 864px;">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('web.language') . ' #' . $language->id }}</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">{{ __('web.language') . ' #' . $language->id }}</div>
                </div>
            </div>
            <div class="section-body">
                <h2 class="section-title">{{ __('web.editing') . ' ' . __('web.language') . ' #' . $language->id }}</h2>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admins.languages.update', $language->id) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card-body col-12 col-md-6 col-lg-6">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                       name="title" value="{{ old('title', $language->title) }}" id="title"
                                            ...
                                            <div class="card-body col-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('locale') is-invalid @enderror"
                                                           name="locale" value="{{ old('locale', $language->locale) }}" id="locale"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" name="backward" value="1" {{ $language->backward ? 'checked' : ''}} class="custom-switch-input">
                                            ...
                                            <!-- Form Default -->
                                            <label class="custom-switch mt-2">
                                                <input type="checkbox" name="default" value="1" {{ $language->default ? 'checked' : '' }} class="custom-switch-input">
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            @if (!$language->default)
                                                <!-- Form Active -->
                                                <label class="custom-switch mt-2">
                                                    <input type="checkbox" name="active" value="1" {{ $language->active ? 'checked' : '' }} class="custom-switch-input">
                                                    <span class="custom-switch-indicator"></span>
                                    ...
                                    <div class="form-group">
                                        @if ($language->img)
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <img src="{{ asset('/storage/images/languages/' . $language->img) }}" width="250" height="250">
                                            </div>
                                        @else
                                            <label class="col-form-label col-12 col-md-3 col-lg-3">{{ __('web.language_flag') }}</label>
                                            <div class="col-sm-12 col-md-7">
