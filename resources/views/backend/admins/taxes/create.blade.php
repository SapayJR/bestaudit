                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admins.taxes.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <!-- Form Title -->
                                            ...
                                            @foreach (config('translatable.locales') as $lang)
                                                <div class="card-body col-12 col-md-{{ count(config('translatable.locales')) > 2 ?  12/2 : 12/count(config('translatable.locales')) }} col-lg-{{ 12/count(config('translatable.locales')) }}">
                                                    ...
                                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                           name="title[{{ $lang }}]" value="{{ old('title:'.$lang) }}" id="title-{{ $lang }}" required >
                                                    @error('title')
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="card-body col-12 col-md-4 col-lg-4">
                                                ...
                                                <input type="text" name="tax_rate" placeholder="%" class="form-control invoice-input" id="keywords">
                                            </div>
                                        </div>
                                    </div>
                                </div>
