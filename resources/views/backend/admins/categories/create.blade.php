                                        ...
                                        <div class="row">
                                           <!-- Parent Category Form -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="type" class="form-control selectric" id="type" required>
                                                        @foreach(\App\Enums\CategoryType::cases() as $type)
                                                            <option value="{{ old('type', $type->value) }}">{{ __('web.' . $type->value) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body col-12 col-md-4 col-lg-4">
                                                ...
                                                <input type="text" name="keywords" class="form-control inputtags" id="keywords">
                                            </div>
                                        </div>
                                    </div>
